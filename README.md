...
Each folder is self-contained, and includes all of the necessary code to reproduce the indicated plots within each paper.  See the __README__ files within each folder for more details.
